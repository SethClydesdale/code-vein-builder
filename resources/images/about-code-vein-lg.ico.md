# About code-vein-lg.ico
This file isn't used on the website. It can however, be used as a folder or shortcut icon if you're using Code Vein Builder offline. Follow the steps below to change the icon of a shortcut or folder.
...
3. Once the icon selector is open click "Browse", navigate to where the code-vein-lg.ico file is located, select code-vein-lg.ico, click open and then OK.
